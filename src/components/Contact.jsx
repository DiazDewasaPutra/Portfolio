...
const socialLinks = [
    {
      href: 'https://github.com/DiazDewasaPutra',
    ...
    {
      href: 'https://www.linkedin.com/in/diaz-dewasa-putra-1865a3336/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://x.com/divineloveeeee',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/diazdewasa',
  ...
  return (
    ...
    >
        <div className="container lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href, icon}, key)=>(
                       <a
                        ...
                        href={href}
                        target="_blank"
                        className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-colo,color] hover-bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <form
            action="https://getform.io/f/axooonrb"
            method="POST"
            className="xl:pl-10 3xl:pl-20"
            >
